...
module.exports = {
	...
	// Project options.
	projectURL: 'Full Stack Entrepreneurship.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'full-stack-entrepreneurship', // Your textdomain here.
	translationFile: 'full-stack-entrepreneurship', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'full-stack-entrepreneurship', // Package name.
