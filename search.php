        ...
        <main id="main" class="site-main" role="main">
            ...
            <header class="page-header layout-center-content text-center">
                ...
                <div class="header-content container-fluid">
                    <?php if ( have_posts() ) : ?>
                        <h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'full-stack-entrepreneurship' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
                    <?php else : ?>
                        <h1 class="page-title"><?php _e( 'Nothing Found', 'full-stack-entrepreneurship' ); ?></h1>
                    <?php endif; ?>
	        ...
	        <div class="container search-items">
		        ...
		        <div class="container">
			        ...
			        the_posts_pagination( array(
				        'prev_text'          => ign_get_svg( array( 'icon' => 'arrow-left' ) ) . '<span class="screen-reader-text">' . __( 'Previous page', 'full-stack-entrepreneurship' ) . '</span>',
				        'next_text'          => '<span class="screen-reader-text">' . __( 'Next page', 'full-stack-entrepreneurship' ) . '</span>' . ign_get_svg( array( 'icon' => 'arrow-right' ) ),
				        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'full-stack-entrepreneurship' ) . ' </span>',
			        ) );
