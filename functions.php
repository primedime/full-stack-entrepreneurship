 ...
 */
function full_stack_entrepreneurship_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed at WordPress.org. See: https://translate.wordpress.org/projects/wp-themes/Full Stack Entrepreneurship
	 * If you're building a theme based on Ignition, and you downloaded this from github, use a find and replace
	 * to change 'full-stack-entrepreneurship' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'full-stack-entrepreneurship' );
    ...
    */
	...
	register_nav_menus( array(
		'top' => __( 'Top Menu', 'full-stack-entrepreneurship' ),
	) );
...
add_action( 'after_setup_theme', 'full_stack_entrepreneurship_setup' );
...
if ( ! function_exists( 'ign_widgets_init' ) ) {
	function ign_widgets_init() {
		register_sidebar( array(
			'name'          => __( 'Sidebar', 'full-stack-entrepreneurship' ),
			'id'            => 'sidebar-1',
			'description'   => __( 'Add widgets here to appear in your sidebar.', 'full-stack-entrepreneurship' ),
...
//footer widgets and sections. up to 4
		register_sidebar( array(
			'name'          => esc_html__( 'Footer', 'full-stack-entrepreneurship' ),
			'id'            => 'sidebar-2',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer 2', 'full-stack-entrepreneurship' ),
			'id'            => 'sidebar-3',
			'description'   => esc_html__( 'Add footer widgets here.', 'pwm' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer 3', 'full-stack-entrepreneurship' ),
			'id'            => 'sidebar-4',
			'description'   => esc_html__( 'Add footer widgets here.', 'pwm' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer 4', 'full-stack-entrepreneurship' ),
			'id'            => 'sidebar-5',
			'description'   => esc_html__( 'Add footer widgets here.', 'pwm' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
 ...
 */
function full_stack_entrepreneurship_scripts() {
	// Add google fonts
	wp_enqueue_style( 'full-stack-entrepreneurship-fonts', ign_google_fonts_url(), array(), wp_get_theme()->get( 'Version' ) );

	// Theme stylesheet. Will get this stylesheet or a child themes stylesheet.
	wp_enqueue_style( 'full-stack-entrepreneurship-style', get_stylesheet_uri(), '', wp_get_theme()->get( 'Version' ) );

	//Sass compiles styles. Will get child's theme version if found instead. Child theme should import with sass.
	wp_enqueue_style( 'full-stack-entrepreneurship-sass-styles', get_theme_file_uri( '/main.css' ), '', wp_get_theme()->get( 'Version' ) );
	...
	wp_enqueue_script( 'full-stack-entrepreneurship-custom-js', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ),
		'1.0', true );

	//AJAX ready for .custom.js files
	wp_localize_script( 'full-stack-entrepreneurship-custom-js', 'frontEndAjax', array(
		'ajaxurl' => admin_url( 'admin-ajax.php' ),
		'nonce'   => wp_create_nonce( 'ajax_nonce' ),
		'url' => home_url(),
	) );

	wp_localize_script( 'full-stack-entrepreneurship-custom-js', 'screenReaderText', array(
		'quote'    => ign_get_svg( array( 'icon' => 'quote-right' ) ),
		'expand'   => __( 'Expand child menu', 'full-stack-entrepreneurship' ),
		'collapse' => __( 'Collapse child menu', 'full-stack-entrepreneurship' )
	) );

	//Icons: add icons for use in custom js here
	wp_localize_script( 'full-stack-entrepreneurship-custom-js', 'icons', array(
...
add_action( 'wp_enqueue_scripts', 'full_stack_entrepreneurship_scripts' );
...
--------------------------------------------------------------*/
/**
 * Full Stack Entrepreneurship abilities and extra filter and functions
