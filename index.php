...
<?php
/*
 * With Full Stack Entrepreneurship You can use the WP Customizer to choose a page to show its sections for an archive page
                ...
                <header class="page-header layout-center-content text-center">
                    ...
                    <div class="header-content container-fluid">
                        <h1>
							<?php
							if ( is_home() ) {
								echo __( 'Blog', 'full-stack-entrepreneurship' );
							} else {
