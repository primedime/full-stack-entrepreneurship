...
function plugin_init() {
	...
	if ( ! function_exists( 'the_row' ) ) {
		function the_row() {
			return __( 'Please install ACF Pro to use this function properly', 'full-stack-entrepreneurship' );
		}
	}
	...
	if ( ! function_exists( 'get_sub_field' ) ) {
		function get_sub_field( $field = '', $id = 0 ) {
			return __( 'Please install ACF Pro to use this funciton properly', 'full-stack-entrepreneurship' );
		}
	}
}
