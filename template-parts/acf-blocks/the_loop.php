				...
				<?php if ( get_sub_field( 'pagination' ) == 'yes' ) { ?>
					<div class="card-pagination text-center">
						...
						the_posts_pagination( array(
							'prev_text'          => ign_get_svg( array( 'icon' => 'angle-left' ) ) . '<span class="screen-reader-text">' . __( 'Previous page', 'full-stack-entrepreneurship' ) . '</span>',
							'next_text'          => '<span class="screen-reader-text">' . __( 'Next page', 'full-stack-entrepreneurship' ) . '</span>' . ign_get_svg( array( 'icon' => 'angle-right' ) ),
