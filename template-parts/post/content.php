...
<?php if ( is_single() ) : ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="entry-content container-content">
			...
			wp_link_pages( array(
				'before'      => '<div class="page-links">' . __( 'Pages:', 'full-stack-entrepreneurship' ),
				'after'       => '</div>',
    ...
    <section class="after-article container-content">
		...
		the_post_navigation( array(
			'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'full-stack-entrepreneurship' ) . '</span><div class="nav-title"><span class="nav-title-icon-wrapper">' . ign_get_svg( array( 'icon' => 'arrow-left' ) ) . '</span> <span>%title</span></div>',
			'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'full-stack-entrepreneurship' ) . '</span><div class="nav-title"><span>%title</span> <span class="nav-title-icon-wrapper">' . ign_get_svg( array( 'icon' => 'arrow-right' ) ) . '</span></div>',
		) );
